...
export function Topbar({ onMenuClick }: TopbarProps) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-20 flex border-b border-slate-200 bg-white/80 backdrop-blur dark:border-slate-700 dark:bg-slate-900/80">
      <div
        className="flex h-14 w-full items-center justify-between px-3 sm:px-4"
